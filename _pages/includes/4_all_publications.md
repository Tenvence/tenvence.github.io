...
- ***AEA: Adaptive Expert Allocation Improves Sentence Embeddings from Mixture-of-Experts LLM***; Shufan Yang, Zifeng Cheng, Zhiwei Jiang, Qingfeng Qi, Yafeng Yin, **Cong Wang**, Ao Zhou, Qing Gu; **ACL**.
- ***IMAGGarment: Fine-Grained Garment Generation for Controllable Fashion Design***; Fei Shen, Jian Yu, **Cong Wang**, Xin Jiang, Xiaoyu Du, Jinhui Tang; **TVCG**.
...
- ***Advanced Sign Language Video Generation with Compressed and Quantized Multi-Condition Tokenization***; **Cong Wang**, Zexuan Deng, Zhiwei Jiang, Yafeng Yin, Fei Shen, Zifeng Cheng, Shiping Ge, Shiwei Gan, Qing Gu; **NeurIPS**.
- ***Steering When Necessary: Flexible Steering Large Language Models with Backtracking***; Zifeng Cheng, Jinwei Gan, Zhiwei Jiang, **Cong Wang**, Yafeng Yin, Xiang Luo, Yuchen Fu, Qing Gu; **NeurIPS**.
- ***Contrastive Prompting Enhances Sentence Embeddings in LLMs through Inference-Time Steering***; Zifeng Cheng, Zhonghui Wang, Yuchen Fu, Zhiwei Jiang, Yafeng Yin, **Cong Wang**, Qing Gu; **ACL**.
- ***Long-Term TalkingFace Generation via Motion-Prior Conditional Diffusion Model***; Fei Shen, **Cong Wang**, Junyao Gao, Qin Guo, Jisheng Dang, Jinhui Tang, Tat-Seng Chua; **ICML**.
...
- ***AP-Adapter: Improving Generalization of Automatic Prompts on Unseen Text-to-Image Diffusion Models***; Yuchen Fu, Zhiwei Jiang, Yuliang Liu, **Cong Wang**, Zexuan Deng, Zhaoling Chen, Qing Gu; **NeurIPS**.
- ***Advancing Pose-Guided Image Synthesis with Progressive Conditional Diffusion Models***; Fei Shen, Hu Ye, Jun Zhang, **Cong Wang**, Xiao Han, Wei Yang; **ICLR**.

## 2023

- ***Learning Event-Specific Localization Preferences for Audio-Visual Event Localization***; Shiping Ge, Zhiwei Jiang, Yafeng Yin, **Cong Wang**, Zifeng Cheng, Qing Gu; **MM**.
- ***Aggregating Multiple Heuristic Signals as Supervision for Unsupervised Automated Essay Scoring***; **Cong Wang**, Zhiwei Jiang, Yafeng Yin, Zifeng Cheng, Shiping Ge, Qing Gu; **ACL**.
- ***Unsupervised Readability Assessment via Learning from Weak Readability Signals***; Yuliang Liu, Zhiwei Jiang, Yafeng Yin, **Cong Wang**, Shen Chen, Zhaoling Chen, Qing Gu; **SIGIR**.
- ***Learning Robust Multi-Modal Representation for Multi-Label Emotion Recognition via Adversarial Masking and Perturbation***; Shiping Ge, Zhiwei Jiang, Zifeng Cheng, **Cong Wang**, Yafeng Yin, Qing Gu; **WWW**.
- ***Controlling Class Layout for Deep Ordinal Classification via Constrained Proxies Learning***; **Cong Wang**, Zhiwei Jiang, Yafeng Yin, Zifeng Cheng, Shiping Ge, Qing Gu; **AAAI**.
